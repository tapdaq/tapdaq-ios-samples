...
extension AppDelegate: TapdaqDelegate {
    
    func log(message: String) {
        NotificationCenter.default.post(name: NSNotification.Name("TapdaqLogMessageNotification"), object: nil, userInfo: [ "message" : message ])
        print("InterstitialOnBootup App: " + message)
    }
